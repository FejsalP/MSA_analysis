...
for file in os.listdir('input'):
    if file.endswith('.clustal'):
        ...
        Select input file
        """
        # file_MSA = "input/output.clustal"
        # file_MSA = "input/Ortho.clustal"
        # file_MSA = "input/Boca.clustal"
        # file_MSA = "input/Aisa.clustal"
        # file_MSA = "input/Adenovirus.clustal"
        # file_CDS = "input/Adenovirus.csv"
        ...
        with open('output/'+file_name+'.txt', 'w') as f:
            f.write('coding sequence length: ' + str(CDS_length)+'\n')
            f.write('non-coding sequence length: ' + str(nonCDS_length))
